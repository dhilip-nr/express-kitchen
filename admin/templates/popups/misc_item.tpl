...
{*
                   <select name="vendor" id="vendor" style="width:90%">
				   <option value="">Select</option>
				   {foreach from=$vendor_query_result key=key item=value}
						<option value="{$value.alias}">{$value.group}</option>
					{/foreach}
				   </select>
*}
                </td>
			...
			<tr>
			 <td class="ilabel">Category</td>
                <td>
				   ...
				   <option value="">Select</option>
				   {foreach from=$category_query_result key=key item=value}
            ...
            <tr>
				...
				<input type="hidden" name="misc_orderid" id="misc_orderid" value="{$order_result.job_order_id}">
...
<form name="sendmailcopy_frm" id="sendmailcopy_frm" method="post" enctype="multipart/form-data">
	...
	<fieldset style="width:575px;">
    	<legend style="display:inline !important;"><strong>{$mailcopydata.title}</strong></legend>
    	<table width="100%">
            <tr>
                <td><strong>Subject</strong></td>
                <td>
                    <input type="text" name="copymail_subject" id="copymail_subject" size="70" value="{$mailcopydata.subject}" readonly class="empty_mail_field" style="border:0px;" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="empty_mail_field" name="copymail_cc" value="{$branch_admin}" id="copymail_cc" size="70" />
                </td>
            </tr>
			<tr>
...
<div id="orderdesign" style="display:none;">
	{if $mailcopydata.has_design != ""}
		<img style="width: 100%;" src="{$mailcopydata.has_design}" alt="Your Design"/>
	{else}
