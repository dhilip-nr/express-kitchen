	...
	<link rel="stylesheet" type="text/css" media="screen" href="catalog/jqgrid/js/jqgrid/css/ui.jqgrid.css?v{$appConstData.app_version}"></link>
	<link rel="stylesheet" type="text/css" media="screen" href="catalog/jqgrid/js/themes/remap/jquery-ui.custom.css?v{$appConstData.app_version}"></link>
...
-->
	...
	<script src="catalog/jqgrid/js/jquery.min.js?v<?=$appConstData["app_version"]?>" type="text/javascript"></script>
	<script src="catalog/jqgrid/js/jqgrid/js/i18n/grid.locale-en.js?v{$appConstData.app_version}" type="text/javascript"></script>
	<script src="catalog/jqgrid/js/jqgrid/js/jquery.jqGrid.min.js?v{$appConstData.app_version}" type="text/javascript"></script>	
	<script src="catalog/jqgrid/js/themes/jquery-ui.custom.min.js?v{$appConstData.app_version}" type="text/javascript"></script>
