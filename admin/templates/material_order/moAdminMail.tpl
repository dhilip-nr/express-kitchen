...
<table cellspacing="0" cellpadding="5" style="border:solid 1px #b4b4b4; width:100%; border-collapse:collapse;">
    ...
    <tr>
        <td colspan="{5+$show_price}" width="100%" style="border-top:0;">
            ...
            <table cellpadding="5" style="width:45%; float:right; border-collapse:collapse; border:solid 1px #ccc; margin-bottom:10px;">
            ...
            <table cellpadding="5" style="width:45%; float:left; border-collapse:collapse; border:solid 1px #ccc; clear:both;">
			...
			{/if}
                <tr style="border:dashed 1px #ccc;">
                    <td width="25%"><b>Company</b></td>
                    <td width="75%">{$vendor_info.company}</td>
                </tr>
                <tr style="border:dashed 1px #ccc;">
                    <td width="25%"><b>Name</b></td>
                    <td width="75%">{$vendor_info.name}</td>
                </tr>
                <tr style="border:dashed 1px #ccc;">
                    <td><b>Email</b></td>
