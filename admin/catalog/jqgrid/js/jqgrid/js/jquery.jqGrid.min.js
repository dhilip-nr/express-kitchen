                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)
                        ...
                        K = function (c, d, e, f, g) {
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                b.isFunction(k.userdata) ? a.p.userData = k.userdata.call(a, c) || {}
                        ...
                        a.updatepager = function (c, d) {
                            ...
                            if (a.p.scroll) {
                                ...
                                if (e = e.outerHeight() ||
                                    ...
                                    g = f * e, m = parseInt(a.p.records, 10) * e, b(">div:first", a.grid.bDiv).css({
                                        height: m
                            ...
                            !0 === a.p.pginput &&
                            (b(".ui-pg-input", n).val(a.p.page), h = a.p.toppager ? "#sp_1" + p + ",#sp_1" + q : "#sp_1" + p, b(h).html(b.fmatter ? b.fmatter.util.NumberFormat(a.p.lastpage, m) : a.p.lastpage)),
                            a.p.viewrecords && (0 === a.p.reccount ? b(".ui-paging-info", n).html(a.p.emptyrecords) : (h = f + 1, l = a.p.records, b.fmatter && (h = b.fmatter.util.NumberFormat(h, m), k = b.fmatter.util.NumberFormat(k, m), l = b.fmatter.util.NumberFormat(l, m)), b(".ui-paging-info", n).html(b.jgrid.format(a.p.recordtext, h, k, l)))),
                            !0 === a.p.pgbuttons && (0 >= e && (e = g = 0), 1 === e || 0 === e ? (b("#first" +
        ...
        setCell: function (e, f, c, d, a, l) {
            return this.each(function () {
                ...
                if (this.grid && (isNaN(f) ? b(this.p.colModel).each(function (a) {
                    ...
                    var n = b("td:eq(" + g + ")", h);
                    if ("" !== c || !0 === l)
                        h = this.formatter(e, c, g, h, "edit"), k = this.p.colModel[g].title ? {
                            title: b.jgrid.stripHtml(h)
                        }
                     : {},
            ...
            return this.each(function () {
                ...
                if (!this.ftoolbar) {
                    ...
                    a.each(c.p.colModel, function (h) {
                        ...
                        var x = "=",
                        q,
                        p = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" +
                                c.p.direction + "'></th>"),
                    ...
                    if (null !== c) {
                        ...
                        case "custom":
                            try {
                                ...
                                "e2" === r ? b.jgrid.info_dialog(b.jgrid.errors.errcap, "function 'custom_value' " +
    ...
    d.jgrid.extend({
        ...
        groupingPrepare: function (b, k) {
            this.each(function () {
                ...
                p = 0;
                for (g = 0; g < m; g++)
                    e = a.groupField[g], h = a.displayField[g], f = b[e], h = null == h ? null : b[h], null == h && (h = f), void 0 !== f && (0 === k ? (a.groups.push({
                                idx: g,
                                dataIndex: e,
                                value: f,
                                displayValue: h,
                                ...
                                return b.extend({
                                    start: function (e, d) {
                                        ...
                                        for (f = 0; f < b.data(c, "dnd").connectWith.length; f++)
                                            0 === b(b.data(c, "dnd").connectWith[f])
                                                .jqGrid("getGridParam",
