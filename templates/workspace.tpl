...
<head>
	...
	<link href="css/workspace.css?v{$timestamp}" rel="stylesheet">
	<link href="css/summary.css?v{$timestamp}" rel="stylesheet">
	...
	<script src="js/blueprint3d.js?v{$timestamp}"></script>
	<script src="js/workspace.js?v{$timestamp}"></script>
